...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--target_language', type=str, help='translate to this language')
        self.parser.add_argument('--api_base_url', type=str, help='api base url for OpenAIModel')
